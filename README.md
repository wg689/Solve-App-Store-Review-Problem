...
https://github.com/wg689/Solve-App-Store-Review-Problem#%E9%97%AE%E9%A2%98-%E5%90%8E%E5%8F%B0%E5%AE%9A%E4%BD%8D%E8%A2%AB%E6%8B%92)
...
<br>
#####1.2)检查服务器是否支持ipv6(这是一个大问题啊,80%的用户无需检查服务器是否支持就直接上线了(笔者就是80%以内的),约20% 的用户需要检查服务器端)
...
<br><br>[另外这个网址也可以测试ipv6连接是否正常,推荐使用这个](http://www.subnetonline.com/pages/ipv6-network-tools/online-ipv6-ping.php),<br>[ipv6测试,这个不推荐使用](http://test-ipv6.com) 这2个测试可以进行ipv6 测试 大家可以选其中一个试试,理论上两个链接的测试结果一样
...
#####1.4)后台服务器不支持ipv6影响上架吗?
服务器不支持ipv6,美国测试的时候肯定需要在ipv6 下面连接你公司的服务器吧,如果你的服务器不支持,苹果在ipv6 下能加载出数据吗?,虽说看似苹果的文档和阿里云的工程师(看起来很权威)说服务器不需要支持ipv6,可是你服务器不支持ipv6加载数据就会出问题,就会导致被拒绝!6box之所以有市场是因为很多服务器不支持ipv6需要买中转服务,6box详情咨询qq:46562334(本人和6box无任何关系,推荐他们只是他们可能会为大家解决问题),当然有人理解和服务器没关系,但是大家需要找到公司谁改去添加AAAA和实现购买中转,让app在ipv6下运行正常.
...
<br>
#####2.1)措施1
用VPN在美国的线路访问服务端试一试,因为有些人在自己搭建的ipv6下可以请求数据,但是在美国的线路访问服务端IPV6无法连接,我知道的有超过5位网友遇到过:"VPN下美国的线路无法连接服务器,不用VPN "测试的ipv6 是可以正常连接的现象"的".这里有问题你就修复这里的问题重新打包ipa提交,不是Reply哦!,很多人问VPN下选择美国线路搭建ipv6热点怎么弄,我画了一个图,如果你用下面的流程图搭建的ipv6热点,最新版QQ,微信都无法联网,那么搭建的ipv6热点就是有问题的(有些VPN不支持ipv6),否则搭建的热点是没问题的.
...
##答案:
[【链接】苹果审核通过后包体大了200多MB！都是Xcode7的](http://www.youxituoluo.com/95823.html)  这个链接可以解答大家的你问
____
