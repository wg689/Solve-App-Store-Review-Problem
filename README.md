...
<br>
#####2.1)措施1
用VPN在美国的线路访问服务端试一试,VPN推荐[鱼摆摆](https://ybb1024.com/),9块钱一个月,有群友可以通过鱼摆摆在VPN美国线路下访问自家的app,虽说鱼摆摆自家的客服说不行,出现ipv6,需要在鱼摆摆的设置->ipv6 _>菜单显示线路是否支持ipv6,优先使用ipv6 这两个选项勾选
